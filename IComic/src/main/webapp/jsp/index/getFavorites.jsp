...
<head>
    ...
    <script>
        function fun3(){
            window.location.href="/static/pages/index/personal-info.jsp";
        }
        function fun4(){
            window.location.href="/static/pages/index/personal-info1.jsp";
        }
    </script>
...
<div class="content wide-content">
    ...
    <div class="col-md-12 text-right">
        <nav>
            <ul class="pagination">
                <li ><a href="/static/getFavoritesByUserId?userId=${userSession.id}">首页 </a></li>
                <li ><a href="/static/getFavoritesByUserId?pn=${favoriteList.pageNum-1}&userId=${userSession.id}">上一页 </a></li>
                <li><a href="#">${favoriteList.pageNum}</a></li>
                <li ><a href="/static/getFavoritesByUserId?pn=${favoriteList.pageNum+1}&userId=${userSession.id}">下一页</a></li>
                <li ><a href="/static/getFavoritesByUserId?pn=${favoriteList.pages}&userId=${userSession.id}">尾页</a></li>
            </ul>
        </nav>
    </div>
    </div>
