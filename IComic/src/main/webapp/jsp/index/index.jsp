                    ...
                    <div class="team-build">
                        <ul>
                            <li><a href="#" class="inline-border" title="Tyl"><img
                                    src="/static/images/slider/project_1.jpg" width="90" height="90" alt="" /></a></li>
                            <li><a href="#" class="inline-border" title="Zwd"><img
                                    src="/static/images/slider/project_2.jpg" width="90" height="90" alt="" /></a></li>
                            <li><a href="#" class="inline-border" title="Czq"><img
                                    src="/static/images/slider/project_3.jpg" width="90" height="90" alt="" /></a></li>
                            <li><a href="#" class="inline-border" title="Wx"><img
                                    src="/static/images/slider/project_4.jpg" width="90" height="90" alt="" /></a></li>
