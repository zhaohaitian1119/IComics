...
<head>
    ...
    <script>
        ...
        function fun3() {
            window.location.href = "/jsp/index/personal-info.jsp";
        }

        function fun6() {
            window.location.href = "/static/getFavoritesByUserId?userId=${userSession.id}";
        }
    </script>
...
<div class="content wide-content">
    <button class="btn btn-primary" onclick="fun3()">基本信息</button>
        ...
        <div class="settings-wrapper" id="pad-wrapper">
            ...
            <div class="span7 personal-info">
                ...
                <form style="display: none">
                    <input type="text" id="user_session" value="${user}"/>
                </form>
