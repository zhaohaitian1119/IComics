...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-inline" method="get" action="/static/getChapterByNumber">
    ...
    <c:forEach items="${chapterList.list}" var="user" varStatus="i">
        <tr>
            ...
            <td>
                ...
                <a href="/static/pages/admin/addChapter.jsp?comicid=${user.comicid}" class="btn btn-primary btn-xs">添加章节</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
...
<div class="col-md-12 text-right">
    <nav>
        <ul class="pagination">
            <li ><a href="/static/chapterList?pn=1&comicid=${comicid}">首页 </a></li>
            <li ><a href="/static/chapterList?pn=${chapterList.pageNum-1}&comicid=${comicid}">上一页 </a></li>
            <li><a href="#">${chapterList.pageNum}</a></li>
            <li ><a href="/static/chapterList?pn=${chapterList.pageNum+1}&comicid=${comicid}">下一页</a></li>
            <li ><a href="/static/chapterList?pn=${chapterList.pages}&comicid=${comicid}">尾页</a></li>
        </ul>
    </nav>
</div>
</c:if>
<script type="text/javascript">
    ...
    function deleteUser(id) {
        if(confirm('确实要删除该章节吗?')) {
            var url="/static/deleteChapterById";
            var args={"id":id};
